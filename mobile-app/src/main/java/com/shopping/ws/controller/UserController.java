...
public class UserController {
	...
	@PutMapping(path = ("/{userId}"), 
			...
			produces = { MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE })
	public  ResponseEntity<UserResponseModel> updateUser(@PathVariable String userId,@Valid @RequestBody UpdateUserRequestModel request) {
		...
		if (users.containsKey(userId)) {
			return new ResponseEntity<UserResponseModel>(users.get(userId), HttpStatus.ACCEPTED);
		} else {
